...
namespace BibliotecaMunicipal.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Autor,Editora")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Nome,Autor,Editora")] Livro livro)
        {
            if (id != livro.Id)
            {
                return NotFound();
